...
BEGIN
	...
	INSERT INTO tbl_care (care_id, care_type, care_specialist)
		...
		('care_1', 'repair old or broken toys', 4),
	...
	/* QUERY the database using INNER JOINS */

	SELECT a1.species_name, a2.animalia_type, a3.class_type, a4.order_type, a5.habitat_type, a6.nutrition_type, a7.care_type
		FROM tbl_species a1
	...
	SELECT a1.species_name, a2.habitat_type, a2.habitat_cost, a3.nutrition_type, a3.nutrition_cost
		FROM tbl_species a1
